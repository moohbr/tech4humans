...
import { Column as Column3, Entity as Entity4, ManyToOne as ManyToOne2, PrimaryGeneratedColumn as PrimaryGeneratedColumn3 } from "typeorm";
...
import { Entity as Entity3, PrimaryGeneratedColumn as PrimaryGeneratedColumn2, Column as Column2, ManyToOne, OneToMany as OneToMany3, CreateDateColumn as CreateDateColumn2 } from "typeorm";
...
_ts_decorate4([
  ...
  _ts_metadata4("design:type", typeof TransactionType === "undefined" ? Object : TransactionType)
], Transaction.prototype, "type", void 0);
_ts_decorate4([
  ManyToOne2(() => Account, {
    nullable: true
  }),
  _ts_metadata4("design:type", typeof Account === "undefined" ? Object : Account)
