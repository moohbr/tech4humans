...
var ConfigSchemas = class {
  ...
  databasePathSchema = z2.string().min(1).refine((val) => val.endsWith(".sqlite"), {
  ...
  envSchema = z2.object({
    ...
    APP_PORT: z2.coerce.number().default(8080),
    APP_HOST: z2.string().optional().default("0.0.0.0"),
    JWT_SECRET: z2.string().optional().default("keyboard cat"),
    NODE_ENV: z2.nativeEnum(NODE_ENV).default(NODE_ENV.DEV),
    SESSION_SECRET: z2.string().optional().default("keyboard cat"),
    OPENAI_API_KEY: z2.string().default("")
  });
};
