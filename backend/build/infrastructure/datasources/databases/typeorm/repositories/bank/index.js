...
__export(bank_exports, {
  TypeOrmBankRepository: () => TypeOrmBankRepository
});
...
var ConfigSchemas = class {
  ...
  databasePathSchema = import_zod2.z.string().min(1).refine((val) => val.endsWith(".sqlite"), {
  ...
  envSchema = import_zod2.z.object({
    ...
    APP_PORT: import_zod2.z.coerce.number().default(8080),
    APP_HOST: import_zod2.z.string().optional().default("0.0.0.0"),
    JWT_SECRET: import_zod2.z.string().optional().default("keyboard cat"),
    NODE_ENV: import_zod2.z.nativeEnum(NODE_ENV).default(NODE_ENV.DEV),
    SESSION_SECRET: import_zod2.z.string().optional().default("keyboard cat"),
    OPENAI_API_KEY: import_zod2.z.string().default("")
  });
};
