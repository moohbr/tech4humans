...
var banks_exports = {};
__export(banks_exports, {
  BankRouter: () => BankRouter
});
module.exports = __toCommonJS(banks_exports);
...
var DeleteAccountOfUserSchemas = class {
  ...
  static requestSchema = import_zod8.z.object({
    accountId: AccountSchemas.accountIdSchema
  });
  static httpRequestSchema = import_zod8.z.object({
...
var AddTransactionToUserSchemas = class {
  ...
  static requestSchema = import_zod11.z.object({
    ...
    transaction: import_zod11.z.object({
...
var GetAllOfUserSchemas = class {
  ...
  static requestSchema = import_zod12.default.object({
    userId: UserSchemas.userIdSchema
  });
  static httpRequestSchema = import_zod12.default.object({
    params: this.requestSchema
  });
};
...
var CreateUserSchemas = class {
  ...
  static requestSchema = import_zod13.z.object({
    account: import_zod13.z.object({
      type: AccountSchemas.accountTypeSchema,
      balance: AccountSchemas.balanceSchema
    }),
    bank: import_zod13.z.object({
  ...
  static httpRequestSchema = import_zod13.z.object({
    body: this.requestSchema
  });
};
...
var UserLoginSchemas = class {
  ...
  static requestSchema = import_zod15.z.object({
    email: UserSchemas.emailSchema,
    password: import_zod15.z.string().min(8).max(100)
  });
...
function errorHandler(err, _req, res, next) {
  ...
  if (err instanceof import_zod26.default.ZodError) {
