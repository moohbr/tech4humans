...
// app/domain/models/user/factory/index.ts
var UserFactory = class {
  static {
    __name(this, "UserFactory");
  }
  static createUser(data) {
    const validatedData = UserSchemas.createUserSchema.parse(data);
    return UserEntity.create(validatedData.name, validatedData.email, validatedData.passwordHash);
  }
  static createUserFromRaw(rawData) {
