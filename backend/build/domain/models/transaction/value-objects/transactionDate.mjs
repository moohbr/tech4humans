...
// app/domain/models/transaction/value-objects/transactionDate.ts
var TransactionDate = class _TransactionDate {
  static {
    __name(this, "TransactionDate");
  }
  value;
  constructor(value) {
    this.value = value;
  ...
  static create(value) {
    ...
    return new _TransactionDate(validatedDate);
  }
  getValue() {
    return this.value;
  }
...
//# sourceMappingURL=transactionDate.mjs.map