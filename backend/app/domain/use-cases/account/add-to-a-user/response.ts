...
export class AddAccountToUserResponse extends EntityResponse<AccountEntity> {
  private constructor(account: AccountEntity | null, success: boolean, message: string, errors: Error[]) {
  ...
  public static failure(message: string, errors: Error[]): AddAccountToUserResponse {
    return new AddAccountToUserResponse(null, false, message, errors);
  }

  public static validationFailure(errors: Error[]): AddAccountToUserResponse {
